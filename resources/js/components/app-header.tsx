...
// Helper: normalize href to a pathname for active checks
                  ...
                  <div className="flex h-full flex-col justify-between text-sm">
                    <div className="flex flex-col space-y-4">
                      {mainNavItems.map((item) => (
                        <Link key={item.title} href={typeof item.href === 'string' ? item.href : (item.href as any).url} className="flex items-center space-x-2 font-medium">
            ...
            <NavigationMenu className="flex h-full items-stretch">
              <NavigationMenuList className="flex h-full items-stretch space-x-2">
                {mainNavItems.map((item, index) => {
                  ...
                  const isActive = toPathname(page.url) === toPathname(href);
                  return (
